...
export async function pedirPresupuesto(
  ...
  // Quema un número de la serie de presupuestos y manda un correo por cada uno.
  const puede = await permitidoPorAmbos("presupuesto", {
    nombre: "correo",
    valor: datos.email,
  });
  ...
  // Igual que en el carrito: si quien pide ya es cliente, el presupuesto queda
  // atado a su ficha.
