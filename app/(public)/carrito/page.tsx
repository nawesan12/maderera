...
import { VistaDelCarrito } from "./vista";
...
export default async function CarritoPage() {
  ...
  return (
    // Esta pantalla sí necesita el carrito entero y resuelto: es lo único que
    // muestra. Es dinámica por eso mismo, así que lo lee del servidor y lo baja
    // por su cuenta, en vez de esperar a que el navegador lo traiga como hace
    // el resto del sitio.
    <CarritoProvider carrito={carrito}>
      <VistaDelCarrito
        sucursales={sucursales.map((s) => ({ id: s.id, nombre: s.nombre }))}
        cortes={carrito.cortes}
        contacto={{
        ...
        <section className="contenedor pb-16">
          <div className="mb-5">
            ...
            <p className="mt-0.5 text-sm text-muted-foreground">
              Lo que suele ir junto con lo que ya tenés en el carrito.
            </p>
          </div>
