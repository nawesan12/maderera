        ...
        <div className="grid grid-cols-1 gap-[38px] md:grid-cols-2 lg:grid-cols-[1.3fr_1fr_1fr_1.2fr]">
          ...
          <div>
            ...
            <div className="mt-4 flex gap-[9px]">
              ...
              <a href={whatsapp} target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white transition-colors hover:bg-[#25D366]">
