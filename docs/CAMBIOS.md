...
| 09/09/2026 | CLIENTE (notas) | Marcar pagos y gastos «en blanco / en negro» | **Rechazado**: un registro de operaciones no declaradas no se construye. La distinción legítima ya existe —gasto con o sin factura—. Pendiente conversarlo con la clienta | — |
