...
CREATE UNIQUE INDEX "subcategories_categoria_slug_idx" ON "subcategories" USING btree ("category_id","slug");--> statement-breakpoint
CREATE INDEX "subcategories_categoria_idx" ON "subcategories" USING btree ("category_id");--> statement-breakpoint
