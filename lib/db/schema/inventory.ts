...
export const branches = pgTable(
  "branches",
  {
    ...
    /**
     * La llave con la ficha publicada.
     *
     * Dirección, teléfono, horario, servicios y destacados **no viven acá**:
     * están en `lib/sucursales.ts`. Son dos locales que la maderera tiene
     * desde hace décadas, y como columnas editables solo lograban que el
     * domicilio del aserradero conviviera en tres versiones distintas en el
     * mismo sitio. Esta tabla guarda lo que la base sí necesita saber: qué id
     * tiene cada sucursal —del que cuelgan el stock, los pedidos, la caja, los
     * remitos y los puntos de venta fiscales— y si está operativa.
     */
    slug: text().notNull(),
    name: text().notNull(),
